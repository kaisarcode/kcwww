#!/bin/sh
#
# Test harness for Bundler utility
#
...
# Functional tests
header "Bundler Tests"

if php "$SCRIPT_DIR/test/test-bundler.php"; then
    pass "All Bundler tests passed"
else
    fail "Bundler tests failed"
fi
