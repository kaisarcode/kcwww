 ...
 */
   ...
   *
   * @return integer|false Whether the database feature is supported, FALSE otherwise.
   **/
 ...
 */
    interface QueryWriter {
       ...
       * @param array       $bindings parameter bindings for additional SQL snippet
       * @param boolean     $select   Select Snippet to use when querying (optional)
       *
       * @return array
       */
       ...
       * @param  boolean $isDep          whether target is dependent and should cascade on update/delete
       *
       * @return void
       */
 ...
 */
   ...
   * @param array|integer $values   rows or count to be stored
   *
   * @return void
   */
 ...
 */
   ...
   */
        public function scanType($value, $flagSpecial = false) {
            ...
            if (
                ( is_numeric( $value) && $value < 2147483648 && $value > -2147483648)
 ...
 */
   ...
   * @param integer $number            number of beans you would like to get
 ...
 */
    class Facade {
       ...
       *
       * @return array|integer|Cursor|NULL
       */
   ...
   * @param boolean|string[] $frozen       whether this database is frozen or not
   * @param boolean|string[] $partialBeans should we load partial beans?
  ...
  */
   ...
   * @param integer         $id    the common ID
   *
   * @return OODBBean[]
   */
